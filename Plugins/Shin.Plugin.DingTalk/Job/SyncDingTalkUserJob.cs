...
public class SyncDingTalkUserJob : IJob
{
    ...
    public async Task ExecuteAsync(JobExecutingContext context, CancellationToken stoppingToken)
    {
        ...
        var _sysUserRep = serviceScope.ServiceProvider.GetRequiredService<ISqlSugarRepository<SysUser>>();
        var _dingTalkUserRepo = serviceScope.ServiceProvider.GetRequiredService<ISqlSugarRepository<DingTalkUser>>();
