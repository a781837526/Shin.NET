...
public sealed class SignatureAuthenticationHandler : AuthenticationHandler<SignatureAuthenticationOptions>
{
    ...
    private readonly ICacheManager _cache = App.GetRequiredService<ICacheManager>();
    ...
    protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        if (_cache.ExistKey(cacheKey)) return await AuthenticateResultFailAsync("重复的请求");
        _cache.Set(cacheKey, null, Options.AllowedDateDrift * 2); // 缓存过期时间为偏差范围时间的2倍
