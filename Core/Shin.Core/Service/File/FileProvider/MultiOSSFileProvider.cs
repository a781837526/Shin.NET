...
public class MultiOSSFileProvider : ICustomFileProvider, ITransient
{
    ...
    /// 系统文件存储提供者服务
    /// </summary>
    private readonly ISysFileProviderService _fileProviderService;
    ...
    /// <summary>
    /// 初始化<see cref="MultiOSSFileProvider"/>类的新实例
    /// </summary>
    public MultiOSSFileProvider(ISysFileProviderService fileProviderService,
