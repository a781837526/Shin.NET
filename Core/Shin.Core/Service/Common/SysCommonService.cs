...
{
    /// <summary>
    /// 提供对<see cref="ApiDescriptionGroup"/>集合的访问权限
    /// </summary>
    ...
    /// <summary>
    /// 初始化<see cref="SysCommonService"/>类的新实例
    /// </summary>
    ...
    public async Task<IActionResult> DownloadErrorExcelTemp([FromQuery] string fileName = null)
    {
        ...
        var resultStream = App.GetRequiredService<ICacheManager>().Get<MemoryStream>(CacheConst.KeyExcelTemp + userId);
