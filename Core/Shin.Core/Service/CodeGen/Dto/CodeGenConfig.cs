...
public class CodeGenConfig
{
    ...
    /// 去掉尾部Id的属性名
    /// </summary>
    public string PropertyNameTrimEndId => PropertyName.TrimSuffix("Id");

    /// <summary>
    /// 去掉尾部Id的属性名
    /// </summary>
    public string LowerPropertyNameTrimEndId => LowerPropertyName.TrimSuffix("Id");
    ...
    {
        "ForeignKey" => $"{PropertyName.TrimSuffix("Id")}FkDisplayName",
        "ApiTreeSelector" => $"{PropertyName.TrimSuffix("Id")}DisplayName",
        "DictSelector" => $"{PropertyName.TrimSuffix("Id")}DictLabel",
        "Upload" => $"{PropertyName.TrimSuffix("Id")}Attachment",
        "Upload_SingleFile" => $"{PropertyName.TrimSuffix("Id")}Attachment",
        _ => PropertyName
    };
