...
public class Startup : AppStartup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseInject(string.Empty, options =>
        {
            ...
            {
                m.OpenApiVersion = OpenApiSpecVersion.OpenApi3_0;
            });
        });

        app.UseEndpoints(endpoints =>
        {
            bool isUseScalarUI = App.GetConfig<bool>("AppSettings:InjectSpecificationDocument", true)
                && App.GetConfig<bool>("AppSettings:InjectScalar", true);
            ...
            if (isUseScalarUI)
            {
                ...
                {
                    options.SetDefaultScalarOptions();
